...
Rows 2/4 and 5 closed — the two items that made the CLI actively dangerous or broken for real users. Rows 8, 10, 11 remain: real gaps, none of them urgent in the same way.

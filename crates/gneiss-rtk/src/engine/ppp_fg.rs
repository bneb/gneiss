...
use crate::math::{
    inversion::{invert_matrix_robust, solve_cholesky_svd},
    thresholding::apply_huber,
};
...
mod mutant_killer_tests {
    ...
    fn test_find_worst_outlier() {
        ...
        assert_eq!(
            PppFactorGraph::find_worst_outlier_sat(&meas_no_outlier),
            None
        );
    }
    ...
    fn test_find_ar_candidates_bounds() {
        let _fg = PppFactorGraph::default();

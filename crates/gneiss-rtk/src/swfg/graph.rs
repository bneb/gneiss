...
mod tests {
    ...
    fn graph_remove_variable_removes_factors() {
        let mut g = EstimationGraph::new();
        let id = g.add_variable(VariableKind::Ambiguity { constellation_id: 0, satellite: 1, frequency: 1, arc: 0 });
        let factor = PriorFactor {
            variable: id,
    ...
    fn graph_total_dim_sums_variable_dims() {
        ...
        g.add_variable(VariableKind::Ambiguity { constellation_id: 0, satellite: 1, frequency: 1, arc: 0 }); // 1

...
pub fn create_tropo_mapper(mapping: TropoMapping, _grid_path: Option<String>) -> Box<dyn TropoMapper> {
    match mapping {
        TropoMapping::Nmf => Box::new(NmfMapper),
        TropoMapping::Gmf => Box::new(GmfMapper),
        TropoMapping::Vmf1 => Box::new(Vmf1Mapper { grid_path: _grid_path }),
    }
}
...
fn _legendre(n: usize, m: usize, t: f64) -> f64 {
    ...
    if n == m {
        let mut fact = 1.0;
        for k in (1..=(2 * m)).step_by(2) { fact *= k as f64; }
...
fn gmf_impl(pos_llh: Vector3<f64>, el: f64, time: GpsTime) -> (f64, f64) {
    ...
    let gmf_anm_h: &[(usize, usize, f64, f64)] = &[
        (0,0, 1.2517e-02, 8.503e-07), (1,0, 2.898e-04, 3.484e-07),
        (1,1, 3.461e-04, 5.585e-07), (2,0,-1.095e-04,-8.316e-07),
        (2,1, 9.573e-05, 6.856e-07), (2,2,-3.775e-06,-2.363e-07),
        (3,0, 4.934e-08, 1.324e-07), (3,1,-4.429e-06,-4.788e-08),
        (3,2,-3.845e-06,-1.353e-07), (3,3, 1.409e-06, 2.188e-08),
        (4,0, 4.642e-07, 2.103e-08), (4,1,-8.124e-08,-1.526e-08),
        (4,2, 7.778e-07, 3.796e-08), (4,3, 6.807e-08,-8.673e-09),
        (4,4,-1.508e-07,-1.039e-08), (5,0, 1.770e-08, 7.371e-09),
        (5,1,-9.282e-08,-3.677e-09), (5,2, 2.200e-09,-1.730e-09),
        (5,3, 3.420e-08, 2.914e-09), (5,4,-3.031e-08, 1.838e-10),
        (5,5, 1.168e-08, 4.397e-10), (6,0,-6.311e-09,-1.453e-09),
        (6,1,-1.210e-08,-5.761e-09), (6,2, 3.155e-10,-1.160e-09),
        (6,3,-2.391e-09, 1.517e-09), (6,4,-1.755e-09, 1.876e-09),
        (6,5,-8.430e-10,-9.922e-10), (6,6,-8.923e-10, 4.103e-10),
        (7,0,-4.952e-12,-2.938e-10), (7,1,-8.094e-10,-1.055e-10),
        (7,2, 3.992e-11,-2.034e-10), (7,3,-5.793e-11,-6.838e-11),
        (7,4, 3.348e-10, 1.628e-10), (7,5, 1.656e-10,-1.356e-10),
        (7,6,-1.920e-10,-7.423e-11), (7,7, 5.204e-11, 6.652e-11),
        (8,0, 4.798e-12,-1.202e-10), (8,1, 5.920e-11,-1.105e-10),
        (8,2,-1.270e-11,-7.845e-11), (8,3,-1.417e-11,-6.232e-11),
        (8,4, 1.188e-11,-3.523e-11), (8,5, 1.377e-11,-3.131e-11),
        (8,6, 3.921e-12,-8.091e-12), (8,7, 8.845e-12, 9.283e-12),
        (8,8,-1.220e-11, 1.393e-12), (9,0, 1.299e-12,-4.025e-11),
        (9,1, 5.078e-12,-1.504e-11), (9,2,-4.109e-12,-1.587e-11),
        (9,3,-7.413e-12,-4.291e-12), (9,4,-3.168e-12,-9.499e-12),
        (9,5,-2.289e-12,-4.520e-12), (9,6, 1.521e-12,-1.704e-12),
        (9,7, 2.637e-12,-1.119e-12), (9,8, 1.187e-12,-1.070e-12),
        (9,9,-4.323e-13,-5.537e-13),
    ];
    let gmf_bh: &[(usize, usize, f64)] = &[
        (0,0, 1.609e-02), (1,0, 1.167e-03), (1,1, 3.127e-03),
        (2,0,-8.636e-04), (2,1,-2.021e-04), (2,2,-1.417e-04),
        (3,0, 1.336e-05), (3,1, 4.247e-05), (3,2,-6.650e-05),
        (3,3, 4.293e-05), (4,0,-9.925e-06), (4,1,-2.575e-06),
        (4,2, 2.074e-05), (4,3,-2.532e-05), (4,4, 1.029e-05),
    ];
    let gmf_ch: &[(usize, usize, f64)] = &[
        (0,0, 8.229e-02), (1,0, 3.979e-03), (1,1,-4.220e-03),
        (2,0, 7.566e-04), (2,1,-3.690e-03), (2,2, 5.868e-04),
        (3,0,-7.270e-04), (3,1,-2.446e-04), (3,2, 1.230e-03),
        (3,3,-7.380e-04), (4,0,-1.276e-04), (4,1, 8.487e-05),
        (4,2,-1.099e-03), (4,3, 8.478e-04), (4,4,-1.404e-04),
    ];
    let gmf_anm_w: &[(usize, usize, f64)] = &[
        (0,0, 5.695e-04), (1,0, 1.839e-05), (1,1, 6.478e-05),
        (2,0, 5.539e-05), (2,1, 1.416e-05), (2,2, 1.476e-05),
        (3,0, 2.825e-06), (3,1, 2.462e-05), (3,2,-5.584e-05),
        (3,3, 2.256e-05), (4,0,-3.221e-06), (4,1, 4.540e-06),
        (4,2, 1.051e-05), (4,3,-1.220e-05), (4,4, 4.357e-06),
        (5,0, 1.996e-06), (5,1, 1.184e-06), (5,2, 4.805e-06),
        (5,3,-3.695e-06), (5,4, 2.477e-06), (5,5,-9.963e-08),
        (6,0,-7.874e-09), (6,1, 2.712e-07), (6,2, 1.584e-06),
        (6,3,-1.039e-06), (6,4,-6.174e-07), (6,5, 4.102e-07),
        (6,6, 2.608e-07), (7,0, 8.460e-08), (7,1,-2.731e-07),
        (7,2,-8.167e-09), (7,3, 7.529e-08), (7,4, 1.884e-07),

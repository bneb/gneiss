...
mod missed_mutant_tests {
    ...
    fn test_evaluate_post_fit_outliers_equal_ratio() {
        ...
        let meas_types = [(SatelliteId::default(), 1), (SatelliteId::default(), 1), (SatelliteId::default(), 1)];
    ...
    fn test_evaluate_post_fit_outliers_exact_ratio_1() {
        ...
        let meas_types = [(SatelliteId::default(), 1), (SatelliteId::default(), 1), (SatelliteId::default(), 1), (SatelliteId::default(), 1), (SatelliteId::default(), 1)];
        let tuning = EkfTuningConfig::default();
        let (idx, val) = evaluate_post_fit_outliers(&nu, &r, &hp, &current_valid, Some(&meas_types), 1.0, false, &tuning);
        assert_eq!(idx, None);
    ...
    fn test_evaluate_post_fit_outliers_exact_valid_count_4() {
        ...
        let meas_types = [(SatelliteId::default(), 1), (SatelliteId::default(), 1), (SatelliteId::default(), 1), (SatelliteId::default(), 1)];
        let tuning = EkfTuningConfig::default();
        let (idx, val) = evaluate_post_fit_outliers(&nu, &r, &hp, &current_valid, Some(&meas_types), 1.0, false, &tuning);
        assert_eq!(idx, None);
